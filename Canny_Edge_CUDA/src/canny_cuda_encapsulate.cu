...
class CudaImageProcessor {
  public:
    ...
    void process(const cv::Mat &input_bgr, cv::Mat &output_gray, int stream_id) {
        ...
        // CUDA_CHECK(cudaMemcpy(d_bgr, input_bgr.data, bgrBytes, cudaMemcpyHostToDevice));
        ...
        // CUDA_CHECK(cudaMemcpy(output_gray.data, d_edge_map, grayBytes, cudaMemcpyDeviceToHost));
...
int main(int argc, char *argv[]) {
    ...
    std::string output_file{"canny_cuda_encapsulate.mp4"};
